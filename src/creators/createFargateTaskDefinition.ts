import { createECSTaskDefinition, fnSub } from '@sjmeverett/cfn-types';

/**
 * Options for `createFargateTaskDefinition`
 */
...
/**
 * Creates an ECS task  definition for a Fargate task
 * @param name
 * @param options
 * @returns
 */
