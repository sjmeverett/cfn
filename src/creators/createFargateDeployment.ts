...
/**
 * Options for `createFargateDeployment`
 */
...
/**
 * Creates a Fargate deployment with a load balancer, logging, domain name, etc.
 * @param name the name to give the deployment
